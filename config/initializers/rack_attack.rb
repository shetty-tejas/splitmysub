# Only configure Rack::Attack in production and staging environments
unless Rails.env.test?
  class Rack::Attack
    ...
    throttle("magic_link_requests/email", limit: 3, period: 30.minutes) do |req|
      if req.path == "/magic_link" && req.post?
        # Parse form data to get email parameter
        begin
  ...
  # Enable rack-attack in production and staging only
