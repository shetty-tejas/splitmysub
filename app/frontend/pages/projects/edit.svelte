<script>
  ...
  function updateRenewalDate() {
    if (form.billing_cycle && form.renewal_date) {
      const currentRenewal = new Date(form.renewal_date);
      const now = new Date();

      // Only update if the current renewal date is in the past
...
<svelte:head>
  <title>Edit {project.name} - SplitMySub</title>
</svelte:head>
    ...
    <div class="mx-auto max-w-2xl">
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Update your subscription project details
          </CardDescription>
        </CardHeader>
        <CardContent>
          <form
            ...
            <div class="space-y-4">
              ...
              <div class="space-y-2">
                ...
                <Textarea
                  ...
                  rows="4"
                  class={errors.payment_instructions
                    ? "border-destructive"
                    : ""}
                />
